...
public class IRIS_RentalHistory extends javax.swing.JFrame{
    ...
    private void table_update(){
        ...
        pst = con.prepareStatement("select * from rental_dump");
        rs = pst.executeQuery();
        ...
        Rs_Table.setAutoCreateRowSorter(true);
                ...
                Logger.getLogger(IRIS_RentalHistory.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
	...
	Object stat = table.getValueAt(row, 11);
    ...
    String logn;
    IRIS_RentalHistory(String logname)
    {   initComponents();
        table_update();
        logn = logname;
    }
    ...
    private void initComponents() {
        ...
        rs_label.setText("Transactions History");
        ...
        Rs_Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Rent ID", "Student Name", "Rent Date", "Room", "Time In", "Time Out", "Item ID", "Item", "Fee", "Officer", "Transaction Date", "Action"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class
            };
        ...
        if (Rs_Table.getColumnModel().getColumnCount() > 0) {
            ...
            Rs_Table.getColumnModel().getColumn(8).setPreferredWidth(25);
            Rs_Table.getColumnModel().getColumn(10).setPreferredWidth(85);
        }
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Rs_Sep)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(rs_label, javax.swing.GroupLayout.PREFERRED_SIZE, 404, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        String logname = logn;
        IRIS_RentalSchedule rf = new IRIS_RentalSchedule(logname);
        rf.setVisible(true);
        rf.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IRIS_RentalHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IRIS_RentalHistory().setVisible(true);
            }
        });
    }
